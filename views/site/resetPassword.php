    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 md:p-16">
        ...
        <div class="w-full max-w-md space-y-6">
            <div class="text-center lg:text-left">
                <h2 class="text-3xl font-bold text-base-content">Restablecer Contraseña</h2>
                <p class="mt-2 text-sm text-base-content/50">Ingresa tu nueva clave a continuación.</p>
            </div>
