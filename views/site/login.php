...
$this->registerMetaTag(['property' => 'og:title', 'content' => 'Iniciar Sesión - Área de clientes ATSYS']);
$this->registerMetaTag(['property' => 'og:description', 'content' => 'Ingresa tus credenciales para acceder al portal.']);
...
<div class="min-h-screen flex bg-base-100">
    ...
    <div class="hidden lg:flex w-1/2 bg-[#134C42]/70 items-center justify-center relative overflow-hidden relative">
        ...
        <div class="absolute bg-black opacity-10 w-96 h-96 rounded-full -top-10 -left-10 blur-3xl"></div>
        <div class="absolute bg-black opacity-10 w-80 h-80 rounded-full bottom-10 right-10 blur-3xl"></div>
        ...
        <div class="z-10 text-center text-primary-content px-10">
            ...
            <h1 class="text-4xl font-bold mb-2">Área de clientes</h1>
    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 md:p-16">
        ...
        <div class="w-full max-w-md space-y-8">
            ...
            ])->textInput(['placeholder' => 'tu@email.com', 'autofocus' => true, 'type' => 'email'])->label('E-mail') ?>
            ...
            ])->passwordInput(['placeholder' => '••••••••'])->label('Contraseña') ?>

            <div class="flex items-center justify-between">
                <?= $form->field($model, 'rememberMe', [
                    'template' => "<div class=\"flex items-center\">{input} {label}</div>",
                    'inputOptions' => ['class' => 'checkbox checkbox-primary checkbox-sm mr-2'],
                    'labelOptions' => ['class' => 'label-text cursor-pointer'],
                ])->checkbox() ?>

                <div class="text-sm">
                    <a href="/site/request-password-reset" class="font-medium text-primary hover:text-primary-focus hover:underline">
