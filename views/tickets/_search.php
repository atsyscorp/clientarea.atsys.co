...
<div class="ticket-search bg-base-200 p-6 rounded-xl mb-6 shadow-sm">
    ...
    <div class="w-full bg-base-100 shadow-xl rounded-box border border-base-200 mb-3 flex gap-4 p-3">
