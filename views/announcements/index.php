    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <?php if ($dataProvider->count > 0): ?>
            <?php foreach ($dataProvider->getModels() as $model): ?>
                ...
                <div
                    class="card bg-base-100 shadow-xl border <?= $borderClass ?> hover:shadow-2xl transition-all h-full flex flex-col group">
                        ...
                        <?php if ($isAdmin): ?>
                            <div class="flex gap-1">
                                ...
                                <?= Html::a(
                                    ...
                                    ['send-mail', 'id' => $model->id],
                                    [
                                        'class' => 'btn btn-sm btn-square btn-ghost text-info',
                                        'title' => 'Enviar Email',
                                        'data' => [
                                            'confirm' => '¿Estás seguro de enviar este comunicado?',
                                            'method' => 'post',
                                        ],
                                    ]
                                ) ?>
