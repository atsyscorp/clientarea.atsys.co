...
<div style='font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #333;'>
    ...
    <p>Para realizar el pago de forma segura a través de <?= $payment_method ?>, haz clic en el siguiente botón:</p>
    ...
    <p style='font-size: 12px; color: #666;'>Si tienes alguna duda sobre esta orden de trabajo, no dudes en
        contactarnos.</p>
</div>